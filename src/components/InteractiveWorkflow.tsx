...
export default function InteractiveWorkflow() {
  ...
  const handleRunSimulation = async () => {
    ...
    addLog("Evaluating buyer intent using AI core metrics...", "info");
          ...
          <div className="space-y-4">
            ...
            <div className={`p-3 rounded-xl border transition-all ${
              ...
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <span className="font-mono text-[10.5px] font-bold text-brand-text">1C. AI Qualification</span>
              </div>
            ...
            <div className={`p-3 rounded-xl border transition-all ${
              ...
              {activeStep === 'agent' && (
                <div className="mt-1.5 flex items-center gap-1.5">
                  ...
                  <span className="text-[9px] font-mono text-purple-600 font-semibold">AI drafting custom reply...</span>
                </div>
              )}
            </div>
